...
;
INSERT INTO `lastGeneratedDates`
VALUES ('1973-03-24');
...
;
INSERT INTO `section`
VALUES (-1, 'GENERAL', 510, 510, 510, 510, 360, 0, 0);
...
CREATE TABLE `calendar` (
  ...
  `idSection` int DEFAULT NULL,
   CONSTRAINT `fk_calendar_worker` FOREIGN KEY (`idWorker`) REFERENCES `worker` (`idWorker`),
  CONSTRAINT `fk_calendar_section` FOREIGN KEY (`idSection`) REFERENCES `section` (`idSection`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb3 COLLATE = utf8mb3_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */
;
/*!40101 SET character_set_client = @saved_cs_client */
